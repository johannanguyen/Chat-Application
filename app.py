...
def bot(input_message):
    if (input_message == "!!about"):
        server_socket.emit('message', {
            "message": "This is the best chat app ever",
            "new_username": "Bot"
        })
        
            
    elif (input_message == "!!pokemon"):
    ...
    elif (input_message.split()[0] == "!!funtranslate"):
        phrase= input_message[15:]
        """
